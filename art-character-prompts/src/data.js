...
export const characterSpecies = {
    humanoid_robot: [
        ...
        {name: 'fairy', googleUrl: '', description: ``, descUrl: ['']},
        {name: 'light elf', googleUrl: '', description: `One of a race of elves who live above ground and are radiant. (Norse mythology) A daylight dwelling elf or nature spirit (as opposed to the underground dwelling dark elves or dwarves).`, descUrl: ['https://en.wiktionary.org/wiki/light_elf#:~:text=One%20of%20a%20race%20of,dwelling%20dark%20elves%20or%20dwarves).']},
        {name: 'dark elf', googleUrl: '', description: `from dark elf wiki: A member of a race of elves that is evil, has a dark (often greyish or bluish) skin and/or lives in dark places.`, descUrl: ['https://en.wikipedia.org/wiki/Dark_elves_in_fiction', 'https://en.wiktionary.org/wiki/dark_elf#English']},
        {name: 'wood elf', googleUrl: '', description: `ood elf is a generic term for an elf that live in wooded areas such as forests.`, descUrl: ['https://en.wikipedia.org/wiki/Wood_Elf']},
        ...
        {name: 'ogre', googleUrl: '', description: `from merriam webster: 1 : a hideous giant of fairy tales and folklore that feeds on human beings `, descUrl: ['']},
        {name: 'gnome', googleUrl: ``, descUrl: ['']},
        {name: 'zombie', googleUrl: ``, descUrl: ['']},
...
export const hybrid = [...characterSpecies.humanoid_robot.map(ch => ch), ...characterSpecies.creature.map(ch => ch)]
...
export const headData= ['horns', 'halo (angel)', 'none']
